            ...
            <div className="container mx-auto max-w-4xl px-4 relative z-20 text-center">
                ...
                >
                    <span className="inline-block text-xs font-bold uppercase text-[#0060AF] bg-blue-100/70 border border-blue-200 px-3 py-1 rounded-md mb-3">
                        Worcester Dispatch & Customer Care
                    </span>
                </motion.div>
                ...
                >
                    Have questions regarding container availability, dimensions, weight allowances, or commercial waste contracts? We are ready to assist you.
                </motion.p>
            </div>
        </section>
    );
